...
public final class KnowledgeIngestionRunner implements ApplicationRunner {
    ...
    private final AtomicReference<IngestionResult> publishedResult = new AtomicReference<>();

    public KnowledgeIngestionRunner(KnowledgeIngestion ingestion) {
    ...
    public IngestionResult publishedResult() {
        return publishedResult.get();
    }
}
